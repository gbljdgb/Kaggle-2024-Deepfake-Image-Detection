# borrow from https://blog.csdn.net/weixin_44023658/article/details/105843701
...
def resnet50(num_classes=1000, include_top=True):
    pretrained_dict = torch.utils.model_zoo.load_url('https://download.pytorch.org/models/resnet50-19c8e357.pth')
